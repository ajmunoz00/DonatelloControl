 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu Dec 10 20:31:41 2020
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME receive_serial
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void receive_serial_Outputs_wrapper(real32_T *v,
			real32_T *w,
			uint8_T *m,
			const real_T *xD);
extern void receive_serial_Update_wrapper(real32_T *v,
			real32_T *w,
			uint8_T *m,
			real_T *xD);
/*====================*
...
{
    real32_T *v = (real32_T *) ssGetOutputPortRealSignal(S, 0);
    real32_T *w = (real32_T *) ssGetOutputPortRealSignal(S, 1);
    uint8_T *m = (uint8_T *) ssGetOutputPortRealSignal(S, 2);
    const real_T *xD = ssGetDiscStates(S);

    receive_serial_Outputs_wrapper(v, w, m, xD);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    receive_serial_Update_wrapper(v, w, m, xD);
